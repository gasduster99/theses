...
<<<<<<< HEAD
modeling all aspects of biomass production (i.e. maturity, recruitment, 
...
%
An intermediate approach between SPM and ASM is the delay differential model (DDM). 
Simple DDM models do not neccessarily model individual growth {\color{red}cite EJ Alec and Aalto et al. 2015}, 
...
growth, etc.) together in the production function. While there are a number of %teasing apart?
...
but still these models are beneficial in modeling the lag between egg production and recruitment into the reproducing population.  %\cite{dick_depletion-based_2011, aalto_separating_2015}.
...
representations of simple individual growth and maturity dynamics integrated directly into\cite{deriso_harvesting_1980, schnute_general_1985, schnute_general_1987}.
...
When information about growth is available DDMs have enough growth and maturity infrastructure present 
to make use of the information without requiring the use of heavily parameterized age stuctured models e.g. \cite{black rockfish assessment}.
...
%RPS
While DDMs are effective and flexible data-poor models, there use in stock 
...
\citep{munyandorero_analytical_2023} gives RP calculations for this model 
under BH, Ricker, and Shepard models, this works adds to that work by deriving 
the RP calculation under the Schnute model. The BH and Ricker special cases of the 
Schnute DDM reiterate the \citeP{Munyandorero2023} calucations, while the Schunte model 
extends those results by also providing RP calulations under the Schafer and 
Cushing models as addittional special cases. Furthmore the Schnute model unifes these 
models with a single analytical result. This study further {\color{red}reveils} that RPs are 
largely dtermined by the form of R. While growth does have an effect on RPs in 
these models, the effect is secondary to the form of R.
>>>>>>> 9158eb13c983dad22eefa99a136ea608e99813ef
