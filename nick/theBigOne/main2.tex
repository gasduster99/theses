...
\vspace{-1cm}
\caption{
Schaefer and PT RP MLEs and associated interquartile regions.  
...
reparameterized directly in terms of their RPs, allowing for straight-forward 
inference. %of RPs. 
%Figure (\ref{exRP}) shows these RP estimates in the broader three-parameter RP space. 
%with the Scahefer model's RP space shown by the horizontal line at $\frac{B^*}{\bar B(0)}=\frac{1}{2}$. 
%ranging from
A number of quirks in these data have been noted over the years including small sample size, 
...
The mere fact that PT can model $\frac{B^*}{\bar B(0)}$ more generally than the 
Schaefer model lets the PT model reflect the shortcomings of these data 
to provide a more honest representation of RP uncertainty.
