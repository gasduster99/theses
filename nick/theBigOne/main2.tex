...
Under the PT model MSY is estimated very similarly to be 254 (verse the Schaefer model's 259) but with wider 95\% 
confidence bounds ranging from 185 to 323. 
...
%the modeled stock.
While nonstationary metamodels could improve the modelling of these 
