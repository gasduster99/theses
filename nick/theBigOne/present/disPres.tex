...
\begin{frame}
	...
	\node at (0,0) {\includegraphics[width=0.8\textwidth]{saCycle.png}\footnote{NOAA Fisheries Annual Stock Assessment Report 2020}};
	\node (a) at (-0.25,-1.65) {};
	\node (b) at (2.5,-1.65) {};
	\onslide<2->{
...
\begin{minipage}[h!]{0.38\textwidth}
	%$~$\\
        \begin{tikzpicture}[overlay]
        \node at (2.35,0.4) {\includegraphics[width=1.25\textwidth]{cjasFig.png}}; %{\includegraphics[height=0.7\textheight]{../../gpBias/designLineHHardExpT45N150M0.3Wide.png}};
...
\begin{itemize}
	...
	\item DDM Analysis, RP Calculations, and Software. % and RP calculations.
\end{itemize}
