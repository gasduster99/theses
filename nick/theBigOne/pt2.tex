...
%logistic parabola, the 
%logistic curve only observes information about its slope at the
...
Under the Schaefer model $\frac{B^*}{\bar B(0)}=0.5$; by transforming metamodel 
predictions of $\log(F^*)$ to $F^*$ metamodeled predictions of Schaefer RPs are obtained.
