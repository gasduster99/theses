...
messy world of biology, all while retaining an approachable quadratic form that allows 
...
production function at the origin). $K$ is the so called "carrying capacity" of 
the population. In this context the carrying capacity can be formally stated as 
...
functional form is very rigid in that it assumes dynamics in the lower 
{\color{red}(mate limited)} regime of the dynamics ($B\in(0, \frac{K}{2})$) 
have the same shape as the upper {\color{red}(density limited)} regime of 
the recruitment dynamics ($B\in(\frac{K}{2}, K)$). 
