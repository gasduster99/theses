...
%\clearpage
\subsection{Dramatic Growth Dynamics}

%
The dramatic growth setting fixes $a_s=2$ and $\kappa=0.1$, to simulate a 
species that grows quite slowly and yet matures into the reproducing  
...
individual growth since individuals recruit at a small size and slowly grow
over the extent of the modeled period. Furthremore by analysis of RPs this 
simulated setting produces that largest deviation of RPs from that of the 
