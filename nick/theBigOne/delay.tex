...
Again under the high contrast setting, Figure (\ref{prodLimit}, $left$) shows 
how the BH model induces bias in both RPs, in accordance with the 
...
%\subsubsection{low}
Similarly in the low contrast setting, Figure (\ref{prodLimit}, $right$) shows 
how two regiems of inference are present. Firstly, there is a region of 
relatively small RP model misspecification where the minimal distance mapping 
...
%
\begin{figure}[h!]
\includegraphics[width=0.49\textwidth]{../ddBias/directionalBiasDDExpT45N150A0-1AS4K0.2.png}
\includegraphics[width=0.49\textwidth]{../ddBias/directionalBiasDDFlatT45N150A0-1AS4K0.2N28.png}
\caption{
