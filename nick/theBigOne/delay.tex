...
occures around values of $\frac{B^*}{\bar B(0)}$ just below 0.4 where in %as opposed 
\mbox{
...
%more uncertain as the model misspecification of the BH model compounds with   

%as growth becomes more emphatic under the 
