...
simplifed expression for $\frac{d \bar{Y}}{dF}$ is provided with $Z=F+M$ 
(representing the total mortality rate) to make a further attempt at brevity in 
the expression.
...
\endgroup
%
Numerical roots of the above expression were calculated using the base R 
uniroot function which employs a derivative free search given by \shortciteA{brent_chapter_1973}.  
