...
%
$\hat y(\textbf{x})$ is the predicted value of the {\color{red}modeled productivity parameter} 
...
%
\paragraph{High Contrast \label{highConRes}}
...
\paragraph{Low Contrast\label{schnuteLowResults}}
