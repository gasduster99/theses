...
default \cite{methot_stock_2013}. %, black}. 
...
\cite{beverton_dynamics_1957} is founded on a notion of density dependence \cite{gotelli_primer_1995}. 
...
developed slightly different (conceptually equilavent) three parameter 
generalizations of the BH model. This model generalizes the BH model by 
controlling the nature of density dependence, by allowing production to 
increase or decrease beyond that of the BH model for large spawning biomass. 
...
also passes through the Ricker and Schaeffer models. As the Schnute model 
transitions between these models it takes intermediate forms which can model 
all of the interviening RPs, thus representing all of the most biologically 
relavant hypotheses.  
