...
Furthermore, the Schnute model analysed here makes an intuitive bridge model 
for developing the use of three-parameter models more generally going forward.
