...
\cite{beverton_dynamics_1957} is founded on the notion of density dependence. 
Like the Schaefer model, the BH model begins the derivation of their 
recruitment relatiohship with a quadratic nonlinear differential equation. 
However in the BH model they essentially model $\frac{dP}{dt}$ with a 
quadriatic logistic model, and solve this equation in discrete time to derive 
their recruitment relationship. Here their recruitment relationship is 
...
%
The paratemer $\alpha$ here has the same interpretation as the $r$ parameter, 
...
{\color{red} talk about including $M$}


{\color{red}
\begin{itemize}
\item history of BH
\item motivate pervasive BH 
