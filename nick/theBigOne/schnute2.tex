...
and still retain well defined RPs. % well defined. %This is not only a typical assumption
...
assumption of linear natural mortality, $-MB$, produces a valid Scheafer model 
with an admissible interpretation.  
