...
place = './modsSchnuteExpT45N150MinCon/'
odeMethod = "lsode"
...
#foreach(i=((length(datFiles)/2):length(datFiles)), .options.multicore = opts) %dopar% {
foreach(i=rev(1:(length(datFiles)/2)), .options.multicore = opts) %dopar% {
