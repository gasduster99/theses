...
plot(dat$time, bl, type='l', col=cols[1], lwd=3, xlab="Time", ylab="Catch", ylim=c(min(bl, tl, tr, br), max(bl, tl, tr, br)), main="Catch")
lines(dat$time, tl, col=cols[2], lwd=3)
lines(dat$time, tr, col=cols[3], lwd=3)
lines(dat$time, br, col=cols[4], lwd=3)
