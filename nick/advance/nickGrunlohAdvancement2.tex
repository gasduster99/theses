...
(\emph{left}) Namibian Hake yearly catch observations. (\emph{right}) Posterior Estimates of instantaious catch with and without assumed uncertatinty in observed catch. 
}
\end{figure}

\begin{align}
\mathds{E}[y(t)] &= k(t)-k(\tau) ~~~ \tau=\lceil t \rceil-1 \\
k(t) &= \int_0^{t} x(t^*) dt^*\\
