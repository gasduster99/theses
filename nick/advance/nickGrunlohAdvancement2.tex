...
common usage in modern fisheries \shortcite{mangel_perspective_2013,punt_extending_2019}.
...
%\begin{figure}[h!]
%	\centering
%	\includegraphics[width=0.4\textwidth]{./plots/srr1.1.png}	
%	\includegraphics[width=0.4\textwidth]{./plots/srr2.png}
%	\caption{\label{srrPT}
...
The Deriso production/recruitment function presents numerical challanges 
that require careful numerics and a different handling of the similation design, but 
...
%Historical 
Current, and historical, databases of commercial landings have not reported 
(or calculated) uncertainty associated with the estimation of catch in the 
northeastern pacific \shortcite{narita_pacfin_1988,calcom_california_2006}. 
...
sorce of uncertainty. However, uncertainty in catch estimation is present, and 
...
explaination for year to year jitters in catch, a statistical explaination 
