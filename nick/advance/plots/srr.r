...
R = 2500
beta = K/2
curve(SRR(x, rGivenRandBeta(K, beta, R), K, K/beta), from=0, to=K, lwd=3, col="black", ylim=c(0, 1.25*R), main=TeX("P(B; r, 10000, $\\gamma$)"), ylab="Production", xlab="B", cex.lab = 1.5, cex.main= 1.5)
rug(beta, lwd=3)
...
curve(SRR(x, r, K, 2), from=0, to=K, lwd=3, ylab="Production", xlab="B", main="Logistic SRR and Related Quantities", cex.lab = 1.5, cex.main= 1.5)
...
curve(SRR(x, r, K, 2), from=0, to=K, lwd=3, ylab="Production", xlab="B", main="Logistic Production and Related Quantities", cex.lab = 1.5, cex.main= 1.5)
#curve(Fr*x, lwd=3, col=cols[1], add=T, lty=2)
#curve(SRR(x, r, K, 2)-Fr*x, from=0, to=K, lwd=3, col=cols[2], add=T)
...
points(K/2, r*K/4, pch=19, cex=1.5)
#curve(SRR(x, r, K, 2)-Fr*x, from=0, to=K, lwd=3, col=cols[2], add=T)
curve(r*x, lwd=3, col=cols[2], lty=1, add=T)
...
#
png("yieldRPplus.png")
curve(SRR(x, r, K, 2), from=0, to=K, lwd=3, ylab="Yield", xlab="B", main="Yield and Related Quantities", cex.lab = 1.5, cex.main= 1.5)
points(K/2, r*K/4, pch=19, cex=1.5)
curve(Fr*x, lwd=3, col=cols[1], add=T, lty=1)
#curve(SRR(x, r, K, 2)-Fr*x, from=0, to=K, lwd=3, col=cols[2], add=T)
#curve(r*x, lwd=3, col=cols[2], lty=1, add=T)
segments(K/2, SRR(K/2, r, K, 2), K/2, 0, col=cols[3], lty=1, lwd=3)
segments(K, SRR(K/2, r, K, 2), K, 0, col=cols[4], lty=1, lwd=3)
legend("topleft", legend=c("Yield", TeX("$B_{0}$"), TeX("$F_{MSY}B$"), TeX("$B_{MSY}$")), col=c("black", cols[c(4, 1, 3)]), lwd=3)#, lty=c(1, 3, 3, 1, 1))
dev.off()

#
png("yieldRPplusP.png")
curve(SRR(x, r, K, 2), from=0, to=K, lwd=3, ylab="Yield", xlab="B", main=TeX("$P(B;\\theta)$"), cex.lab = 1.5, cex.main= 1.5)
points(K/2, r*K/4, pch=19, cex=1.5)
curve(Fr*x, lwd=3, col=cols[1], add=T, lty=1)
#curve(SRR(x, r, K, 2)-Fr*x, from=0, to=K, lwd=3, col=cols[2], add=T)
#curve(r*x, lwd=3, col=cols[2], lty=1, add=T)
...
cols = brewer.pal(9,'Set1')
png("derisoSrr.png")
curve(SSRDeriso(x, sm, rm, 3), from=0, to=K*1.5, add=F, n=10000000, lwd=3, col="grey30", ylim=c(0, 3000), main=TeX("P(B; $\\theta$=$\\[\\alpha$, $1/\\beta$, $\\gamma\\]$)"), ylab="Production", xlab="B", cex.lab = 1.5, cex.main= 1.5)
