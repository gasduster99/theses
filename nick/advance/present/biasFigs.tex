...
%\begin{minipage}[h!]{0.49\textwidth}
%\begin{itemize}
%	{\item \color{red}What should $P$ do?}
%\end{itemize}
%\hspace*{1cm}
%\includegraphics[width=0.75\textwidth]{../plots/hakeIndex.png}\\
%\hspace*{1cm}
%\includegraphics[width=0.75\textwidth]{../plots/hakeCatch.png}
%\end{minipage}
\end{frame}
...
Three parameter SRR\\
functional form with oprthogonal RPs
\includegraphics[width=0.45\textwidth]{shaeferConst.png}
\end{frame}
...
\begin{minipage}[h!]{0.44\textwidth}
%\includegraphics[width=\textwidth]{~../../.././nick/gpBias/srrSchaeffer.png}
\includegraphics[width=\textwidth]{../plots/srr1.1.png}
\end{minipage}
\end{frame}
...
\begin{align*}
\\
C(t) = F^*\left(\frac{F(t)}{F^*}\right)B(t)\\
\end{align*}
}
\only<2>{
\vspace*{-0.1cm}
...
\begin{minipage}[h!]{0.49\textwidth}
\hspace*{1cm}
\includegraphics[width=0.75\textwidth]{../../.././nick/gpBias/curveCompareFlatNoQX0.5Z0.6.png}\\
%\vspace*{1.5cm}
\hspace*{1cm}
\includegraphics[width=0.75\textwidth]{../../.././nick/gpBias/curveCompareFlatNoQX0.5Z0.2.png}
\end{minipage}
\begin{minipage}[h!]{0.49\textwidth}
%\hspace*{-1cm}
\includegraphics[width=0.75\textwidth]{../../.././nick/gpBias/curveCompareFlatNoQX3.5Z0.6.png}\\
%\vspace*{-0.5cm}
\includegraphics[width=0.75\textwidth]{../../.././nick/gpBias/curveCompareFlatNoQX3.5Z0.2.png}
\end{minipage}
...
\hspace*{-1cm} y(\tau_i) &= \beta_0 + \sum_{j=1}^{i-1} \beta_j \left[ \left(\frac{\tau_i^2}{2}-\tau_j\tau_i\right)\mathds{1}_{\tau_i>\tau_j} - \left(\frac{\tau_{i-1}^2}{2}-\tau_j\tau_{i-1}\right)\mathds{1}_{\tau_{i-1}>\tau_j}\right] + \epsilon_i \\
