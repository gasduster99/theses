...
%\hspace*{-0.25cm}
%\vspace*{3.5cm}
%\includegraphics[width=1.2\textwidth]{../../.././nick/gpBias/bMSYRelBiasPellaFlatNoQ.png}
%\end{minipage}
%\begin{minipage}[h!]{0.325\textwidth}
%\hspace*{0.25cm}
%\vspace*{-3.5cm}
%\includegraphics[width=1.2\textwidth]{../../.././nick/gpBias/kRelBiasPellaFlatNoQ.png}
%\end{minipage}
%\hspace*{-1cm}
%\includegraphics[width=0.4\textwidth]{../../.././nick/gpBias/zetaRelBiasPellaFlatNoQ.png}
%\includegraphics[width=0.4\textwidth]{../../.././nick/gpBias/bMSYRelBiasPellaFlatNoQ.png}
%\hspace*{7cm}
%\vspace*{-2cm}
%\includegraphics[width=0.4\textwidth]{../../.././nick/gpBias/kRelBiasPellaFlatNoQ.png}
