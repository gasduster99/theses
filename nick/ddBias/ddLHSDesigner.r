...
#
aS = 2	#2 #10 0.1		#2  #15   #0.1  #15     #15  #7.5 #15  #1
a0 = -1 	#-0.25 #-0.5 #-1   #-2
M  = 0.2 	#0.005
...
#
xlim = c(2.8, 3.6) #c(0.25, 3.75)
ylim = c(0.25, 0.45) #c(0.15, 0.7) #0.6) #
...
#
inPlace = "./modsDDFlatT45N150A0-1AS2K0.1N84Corner/" #K10/"#"ExpT45N300A0-1AS10K0.1/" #"./modsDDFlatT45N300A0-1AS10K0.1N56/" #"./modsDDExpT45N300AS0.1K10/" #"./modsDDFlatT30N150A15K0.1/" #"./modsDDExpT45N150A15/" 		#"./modsSchnuteHHardFlatT30N150WWideN84/"#"./modsSchnuteExpT30L3N150Wide/" #"./modsSchnuteHHardExpT45N150M0.1Wide/" #"./modsSchnuteHHardFlatT30
outPlace = sprintf("./modsDDFlatT45N150A0-1AS2K0.1N%dEdge/", 84) #sprintf("./modsDDExpT45N150A15N%d/", n) 	#sprintf('./modsSchnuteHHardFlatT30N150WWideN%s/', 4*n) #sprintf('./modsSchnuteHHardFlatT30N150WWideAdapt%s/', thresh)
