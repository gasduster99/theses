...
#
curve(vbGrow(x, kappa, WW, a0), -1, 15, lwd=3, xlab="Age", ylab="Biomass", main="VB Growth", ylim=c(0, WW), col='red')
...
ww = vbGrow(aS, kappa, WW, a0)
#
curve(vbGrow(x, kappa, WW, a0), -1, 15, lwd=3, xlab="Age", ylab="Biomass", main="VB Growth", ylim=c(0, WW), col='purple', add=T)
...
ww = vbGrow(aS, kappa, WW, a0)
#
curve(vbGrow(x, kappa, WW, a0), -1, 15, lwd=3, xlab="Age", ylab="Biomass", main="VB Growth", ylim=c(0, WW), col='blue', add=T)
