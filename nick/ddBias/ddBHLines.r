...
ks = logseq(0.01, 10, n=kI) #seq(0.01, 15, length.out=kI) #0.5)
...
#
for(ai in rev(1:aI)){ #sample(1:aI)){	
...
legend("topright", 
	legend = c(
		TeX("$a_s$ High"), TeX("$kappa$  High")
		#, TeX("$M$ High")
	), 
	col = c(
		rgb(0,0,255,alpha=100, maxColorValue=255), rgb(255,0,0,alpha=100, maxColorValue=255) 
