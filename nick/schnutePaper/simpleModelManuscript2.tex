...
%
Each design location of the simulation results in an MLE of each of the productivity
...
independent instances of the following model in Eq (\ref{GPModel}).
...
\caption{
Joint bias direction for ($F_{MSY}$, $\frac{B_{MSY}}{B_0}$) estimates under the misspecified Schaefer Model. The intensity of color represents the excess bias relative to the shortest possible mapping. 
}
\end{figure}
