...
simulation setting. The primary difference in this low constrast setting, is 
the break point around $\frac{B^*}{\bar B(0)}=0.4$ above which $\frac{F_{MSY}}{M}$ 
...
this break point coincides with a regime change in the data generating Schnute 
model. The Ricker model lies along this regime interface, which represents the 
first model to approach the x-axis for large biomasses as $\gamma$ increases. 
