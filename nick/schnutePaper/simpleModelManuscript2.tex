...
across the space of possible stock. Furthermore, the simulation design taken together 
...
how that geometry is misspecified relative to the data. The RP mapping is oriented 
...
maximally informative fishing rate, 

Conjecture that the RP mapping under maximally informative data  

and does not perfectly 
result in 
I conjecture that a perfectly informative data se
