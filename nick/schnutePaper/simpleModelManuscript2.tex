...
\end{minipage}
\caption{Joint bias direction for $\left(\frac{F_{MSY}}{M}\right.$, $\left.\frac{B_{MSY}}{B_0}\right)$ 
estimates under the misspecified BH Model. The intensity of color represents the excess bias relative 
to the shortest possible mapping. The high constrast relative fishing setting is 
...
%
Figure (\ref{bhArrows}, $right$) shows the mapping of RPs under BH inference in 
