...
function which describes the number of individuals recruiting into the expoitable
population as a function of biomass 

 how new individuals are added to the numbers equation.
The biomass equation of the above model can be seen to expand the notion of 
biomass production into the processes of recruitment, individual growth, and 
maturity.  The $B$ dynamics,
