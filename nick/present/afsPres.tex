...
%
\begin{frame}{General Surplus-Production Structure}
\hspace*{-0.5cm}
\begin{minipage}[h!]{0.49\textwidth}
\begin{align*}
...
\end{minipage}
\begin{minipage}[h!]{0.49\textwidth}
\includegraphics[width=\textwidth]{./derisoSrr.png}
\end{minipage}
\end{frame}
...
\begin{frame}{\color{orange}Simulation Design}
\begin{center}
\includegraphics[height=0.9\textheight]{../gpBias/designLineHHardExpT45N150M0.3Wide.png}
\end{center}
\end{frame}
...
\begin{center}
\begin{tikzpicture}[overlay]
	\node at (0.25,-0.5) {\includegraphics[height=0.92\textheight]{../gpBias/directionalBiasSchnuteAnimateBaseExpT45N150WideX2.5Z0.45.png}};
	%\node at (4.5,2)  {\includegraphics[scale=0.15]{../gpBias/yeildCurveTruthExpT45N150WideX3.348Z0.541.png}};
	%\node at (-4.75,-2.5)  {\includegraphics[scale=0.15]{../gpBias/yeildCurveFitExpT45N150WideX3.348Z0.541.png}};
\end{tikzpicture}
\end{center}
...
\begin{center}
\begin{tikzpicture}[overlay]
	\node at (0.25,-0.5) {\includegraphics[height=0.92\textheight]{../gpBias/directionalBiasSchnuteAnimateBaseHHardFlatT30N150WWideN56X3Z0.55.png}};
...
\begin{center}
\begin{tikzpicture}[overlay]
	\node at (0.25,-0.5) {\includegraphics[height=0.92\textheight]{../gpBias/directionalBiasSchnuteAnimateSourceHHardFlatT30N150WWideN56X3Z0.55.png}};
	\node at (4.75,1.5)  {\includegraphics[scale=0.18]{../gpBias/yeildCurveTruthHHardFlatT30N150WWideN56X3Z0.55.png}};
	%\node at (-4.75,-2.5)  {\includegraphics[scale=0.15]{../gpBias/yeildCurveFitHHardFlatT30N150WWideN56X3.497Z0.578.png}};
\end{tikzpicture}
\end{center}
}
...
\begin{center}
\begin{tikzpicture}[overlay]
	\node at (0.25,-0.5) {\includegraphics[height=0.92\textheight]{../gpBias/directionalBiasSchnuteAnimateSinkHHardFlatT30N150WWideN56X3Z0.55.png}};
	\node at (4.75,1.5)  {\includegraphics[scale=0.18]{../gpBias/yeildCurveTruthHHardFlatT30N150WWideN56X3Z0.55.png}};
	\node at (-4.75,1.5)  {\includegraphics[scale=0.18]{../gpBias/yeildCurveFitHHardFlatT30N150WWideN56X3Z0.55.png}};
\end{tikzpicture}
\end{center}
}
%\only<4>{
...
\begin{center}
\begin{tikzpicture}[overlay]
	\node at (0.25,-0.5) {\includegraphics[height=0.92\textheight]{../gpBias/directionalBiasSchnuteAnimateSourceHHardFlatT30N150WWideN56X3Z0.35.png}};
	\node at (4.75,-1)  {\includegraphics[scale=0.18]{../gpBias/yeildCurveTruthHHardFlatT30N150WWideN56X3Z0.35.png}};
	%\node at (-4.75,-2.5)  {\includegraphics[scale=0.15]{../gpBias/yeildCurveFitHHardFlatT30N150WWideN56X3.497Z0.578.png}};
\end{tikzpicture}
\end{center}
}
...
\begin{center}
\begin{tikzpicture}[overlay]
	\node at (0.25,-0.5) {\includegraphics[height=0.92\textheight]{../gpBias/directionalBiasSchnuteAnimateSinkHHardFlatT30N150WWideN56X3Z0.35.png}};
	\node at (4.75,-1)  {\includegraphics[scale=0.18]{../gpBias/yeildCurveTruthHHardFlatT30N150WWideN56X3Z0.35.png}};
	\node at (-4.75,-2.25)  {\includegraphics[scale=0.18]{../gpBias/yeildCurveFitHHardFlatT30N150WWideN56X3Z0.35.png}};
\end{tikzpicture}
\end{center}
}
%\only<6>{
...
\subsection{}
%
\begin{frame}{\color{orange}Conclusions}
\begin{itemize}
	\color{orange}
	\item Contrast story
