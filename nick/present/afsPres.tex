...
\begin{tikzpicture}[overlay]
	\node at (0,-0.5) {\includegraphics[height=1\textheight]{../gpBias/directionalBiasSchnuteAnimateBaseExpT45N150Wide.png}};
...
\begin{center}
\begin{tikzpicture}[overlay]
	\node at (0,-0.5) {\includegraphics[height=1\textheight]{../gpBias/directionalBiasSchnuteAnimateSourceExpT45N150Wide.png}};
	\node at (4.5,2)  {\includegraphics[scale=0.15]{../gpBias/yeildCurveTruthExpT45N150WideX3.348Z0.541.png}};
	%\node at (-4.75,-2.5)  {\includegraphics[scale=0.15]{../gpBias/yeildCurveFitExpT45N150WideX3.348Z0.541.png}};
\end{tikzpicture}
\end{center}
...
\begin{center}
\begin{tikzpicture}[overlay]
	\node at (0,-0.5) {\includegraphics[height=1\textheight]{../gpBias/directionalBiasSchnuteAnimateSinkExpT45N150Wide.png}};
	\node at (4.5,2)  {\includegraphics[scale=0.15]{../gpBias/yeildCurveTruthExpT45N150WideX3.348Z0.541.png}};
	\node at (-4.75,-2.5)  {\includegraphics[scale=0.15]{../gpBias/yeildCurveFitExpT45N150WideX3.348Z0.541.png}};
\end{tikzpicture}
\end{center}
