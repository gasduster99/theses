...
colnames(gaOut@solution) = c('q', 'r', 'K', 's', 'B0')
...
#)
#output
sHat  = gaOut@solution[4] #0.12   	#optimOut$par[4]	#
qHat  = gaOut@solution[1] #0.00045	#optimOut$par[1]	#
rHat  = gaOut@solution[2] #0.39   	#optimOut$par[2]	#
KHat  = gaOut@solution[3] #2709   	#optimOut$par[3]	#
B0Hat = gaOut@solution[5] #KHat	#optimOut$par[5] 	#
#
