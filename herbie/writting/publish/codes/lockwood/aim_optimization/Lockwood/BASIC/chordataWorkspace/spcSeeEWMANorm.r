...
name = "Lock6Three20000"; uu=90; lambda=0.25
...
W = uu
tMin = min(ZMax = seaSave[[1]][[175]]) - 1000
#
fudge = 0
...
wasd = function(name){
	...
	if( move=="d" | move=="w" ){
		...
		saveBest = sprintf("cp ./bestZ%s.pdf /home/nick/Documents/school/ucscGrad/thesis/herbie/writting/publish/nickHerbie/figures/bestZ%s%s.pdf", name, name, add)
