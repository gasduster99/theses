...
bool LangmuirPartitionIsotherm::Initialize(char * pStr)
{
   ...
   char * begin = "BeginLangmuir-PartitionIsotherm";
   char * end   = "EndLangmuir-PartitionIsotherm";
...
bool TothIsotherm::Initialize(char * pStr)
{
   ...
   char * begin = "BeginTothIsotherm";
   char * end   = "EndTothIsotherm";
...
bool LangmuirFreundlichIsotherm::Initialize(char * pStr)
{
   ...
   char * begin = "BeginLangmuir-FreundlichIsotherm";
   char * end   = "EndLangmuir-FreundlichIsotherm";
