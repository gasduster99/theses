...
int main(int argc, StringType argv[])
{
   ...
   while(bDone == false)
   {
      ...
      ISO_CreateOstrichFile("CCPSO", pList, false, &Glob);
      ...
      if(Glob.bFitAll == true)
      {
         ...
         sprintf(tmpStr, "OstExeOut_%s.txt", gIsoNames[i]);
         remove(tmpStr);
         rename("OstExeOut.txt", tmpStr);
...
******************************************************************************/
void ISO_FileToStr(char * file, char * pStr, int size)
{
...
******************************************************************************/
void ISO_CreateOstrichFile(char * pProgType, IsoParamList * pList, bool stats, 
                           IsoGlobStruct * pArgs)
{
