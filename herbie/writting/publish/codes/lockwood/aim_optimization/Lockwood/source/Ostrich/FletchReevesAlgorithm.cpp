...
DTOR
******************************************************************************/
FletchReevesAlgorithm::~FletchReevesAlgorithm(void)
{ 
   Destroy();
}/* end DTOR */
...
Optimize the objective function using the Fletcher-Reeves algorithm, as 
described in Numerical Recipes, Press et. al., pages 420-424.
******************************************************************************/
