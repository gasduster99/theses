...
******************************************************************************/
ADOConnection::ADOConnection(string connectionString)
{
   bstrConnect = connectionString.c_str();
...
******************************************************************************/
void ADOConnection::Write(char * table, char * keyColumn, char * key, char * column, char * param)
{
   try
   {
	   string s_table(table);
