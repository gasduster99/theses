figPlace = "~/Documents/school/ucscGrad/thesis/herbie/writting/publish/nickHerbie/figures/"
...
#}
##
#pdf(sprintf("%sroseContourBW.pdf", figPlace))
# define jet colormap
jet.colors <- colorRampPalette(c("#00007F", "blue", "#007FFF", "cyan", "#7FFF7F", "yellow", "#FF7F00", "red", "#7F0000"))
bw = colorRampPalette(c('black', 'white'))
##
#filled.contour( dimX, dimY, Z,
#                        color.palette = bw,#jet.colors,
#                        xlab=expression(x[1]),
#                        ylab=expression(x[2]),
#                        #main='Rosenbrock',
#			#zlim=c(0, 3000)
#			plot.axes={ points(c(1), c(1), col="red", pch=1); axis(1); axis(2) }
#)
#dev.off()
##
...
#
#dev.new()
pdf(sprintf("%srastContourBW.pdf", figPlace))
# define jet colormap
jet.colors <- colorRampPalette(c("#00007F", "blue", "#007FFF", "cyan", "#7FFF7F", "yellow", "#FF7F00", "red", "#7F0000"))
filled.contour( dimX, dimY, Z,
                        color.palette = bw,
                        ...
                        #main='Rastrigin',
			#zlim=c(0, 3000)
			plot.axes={ points(c(0), c(0), col="red", pch=1); axis(1); axis(2) }			
)
dev.off()
#
##dev.new()
