...
class RealParam : public ParameterABC
{
   public:      
      ...
      RealParam(IroncladString name, double initialValue, 
                ...
                IroncladString txOst, IroncladString txOut);     
      ~RealParam(void){ Destroy();}
      void Destroy(void);

      void   GetValAsStr(UnmoveableString valStr){ GetPreciseValAsStr(valStr, GetTransformedVal());}
...
class IntParam : public ParameterABC
{
   public:      
      ...
      char * GetType(void) {return "integer";}
...
class ComboIntParam : public ParameterABC
{
   public:      
      ...
      char * GetType(void) {return "combinatorial integer";}
...
class ComboDblParam : public ParameterABC
{
   public:      
      ...
      ~ComboDblParam(void){ Destroy();}
      void Destroy(void);

      void GetValAsStr(UnmoveableString valStr){GetPreciseValAsStr(valStr, m_pCombos[m_CurIdx]);}
      void Write(FILE * pFile, int type);
      double GetLwrBnd(void){ return 0.00;}
      double GetUprBnd(void){ return (double)(m_NumCombos - 1);}
      void SetLwrBnd(double val){ return;}
      ...
      void SetThreshVal(double lwr, double upr, double off){ return;}
      char * GetType(void) {return "combinatorial double";}
...
class ComboStrParam : public ParameterABC
{
   public:      
      ...
      void SetThreshVal(double lwr, double upr, double off){ return;}
      char * GetType(void) {return "combinatorial string";}
...
class SpecialParam
{
   public:      
      ...
      //threshold values (allow for implicit on/off of parameters)
      void SetThreshVal(double lwr, double upr, double off){ return;}
      char * GetType(void) {return "special";}
