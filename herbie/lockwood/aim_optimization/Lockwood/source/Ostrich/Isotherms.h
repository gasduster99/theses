...
{ 
   public :
      ...
      ~DualLangmuirIsotherm(void){ Destroy();}
...
{ 
   public :
      ...
      ~FreundlichIsotherm(void){ Destroy();}
...
{ 
   public :
      ...
      ~PolanyiPartitionIsotherm(void){ Destroy();}
...
{ 
   public :
      ...
      ~LangmuirPartitionIsotherm(void){ Destroy();}
...
{ 
   public :
      ...
      ~LangmuirFreundlichIsotherm(void){ Destroy();}
...
{ 
   public :
      ...
      ~FreundlichPartitionIsotherm(void){ Destroy();}
