...
07-08-04    lsm   WriteSetup() is first action of algorithm, moved SQR() to 
                  NumericalRecipes.cpp/.h files.
...
DTOR
******************************************************************************/
PowellAlgorithm::~PowellAlgorithm(void)
{ 
   Destroy();
}/* end DTOR */
...
Optimize the objective function using Powell's algorithm, as described in 
Numerical Recipes in C, Press, et. al., pages 415-418.
******************************************************************************/
