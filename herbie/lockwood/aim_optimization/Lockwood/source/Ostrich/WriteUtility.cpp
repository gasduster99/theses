...
fprintf(pFile,
"--------------------------------------------------------------------------\n \
ISOFIT version %02d.%02d.%04d (Built %s @ %s)\n\n \
...
--------------------------------------------------------------------------\n\n",
month, day, year, __DATE__, __TIME__);
#endif

fprintf(pFile,
"--------------------------------------------------------------------------\n \
OSTRICH version %02d.%02d.%04d (Built %s @ %s)\n\n \
...
******************************************************************************/
void WriteSetup(ModelABC * pModel, char * algStr)
{
   FILE * pFile;
...
******************************************************************************/
void WriteSetupNoDisclaimer(ModelABC * pModel, char * algStr)
{
   FILE * pFile;
   char fileName[DEF_STR_SZ];
   int num_procs;
...
Write out Ostrich Setup
******************************************************************************/
void WriteSetupToFile(FILE * pFile, ModelABC * pModel, char * algStr)
{
...
******************************************************************************/
void WriteBanner(ModelABC * pModel, char * pBef, char * pAft)
{
   FILE * pFile;
   char fileName[DEF_STR_SZ];
   int num_procs;
...
Write out iteration banner
******************************************************************************/
void WriteBannerToFile(FILE * pFile, ModelABC * pModel, char * pBef, char * pAft)
{
